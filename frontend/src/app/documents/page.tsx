...
export default function DocumentsPage() {
	...
	async function action(id: number, path: string, method: string) {
		...
		const response = await apiFetch(`/api/documents/${id}${suffix}`, { method });
	...
	return (
		<AppShell title="Documents"><div className="page-heading"><div><h1>Documents</h1><p>Manage and access your generated documents.</p></div><Link href="/dashboard" className="primary-button">＋ New Document</Link></div>
